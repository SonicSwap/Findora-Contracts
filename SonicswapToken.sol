...
contract SonicswapToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    uint256 private _maxSupply = 100000000 * 10**decimals(); // 100 million token is the maximum supply
    uint256 private _initialSupply = 50000 * 10**decimals(); // 50,000 token is the initial supply

    event TokensRescued(address indexed sender, address indexed token, uint256 value);

    constructor() ERC20("SonicSwap Token", "SONIC") ERC20Permit("SonicSwap Token") {
